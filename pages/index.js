      ...
      <div className="space-y-2 pt-6 pb-4 md:space-y-5">
        ...
        <p className="space-y-4 text-zinc-500 dark:text-slate-300">
          <p className="my-4 leading-loose">
            Graduated from a Bachelor of Communication Science{' '}
            <a
            ...
            My web portfolio showcases my work in various creative fields, including graphic design,
            web design, and UI/UX design. I'm passionate about creating visually appealing and
            user-friendly designs that effectively communicate ideas and engage audiences. Please
            take a look around to explore my projects and learn more about my design process.{' '}
          </p>
        </p>
        <div className="mt-8 flex flex-wrap gap-4 text-center">
          ...
          <a
            ...
            href="mailto:giraldipramay@gmail.com"
          >
            <svg height="24" role="presentation" width="24" xmlns="http://www.w3.org/2000/svg">
              <path
                clipRule="evenodd"
